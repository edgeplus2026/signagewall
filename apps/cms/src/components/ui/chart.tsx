/**
 * Vendored shadcn "chart" primitive, adapted to the app's design tokens. The
 * upstream component reads Recharts' loosely-typed tooltip/legend payloads, which
 * trip the project's strict type-aware lint rules — scoped off for this file only.
 */
/* eslint-disable @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-argument, @typescript-eslint/no-unnecessary-condition, @typescript-eslint/restrict-template-expressions */
