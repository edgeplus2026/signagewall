...
export function OneDriveIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className}>
      <path
        d="M19.35 10.04A7.49 7.49 0 0 0 12 4a7.49 7.49 0 0 0-6.9 4.5A5 5 0 0 0 6 18h13a4 4 0 0 0 .35-7.96Z"
        fill="#0364B8"
      />
    </svg>
  )
...
export function DropboxIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} fill="#0061FF">
      <path d="M6 1.807 0 5.629l6 3.822 6-3.822zm12 0-6 3.822 6 3.822 6-3.822zM0 13.274l6 3.822 6-3.822-6-3.822zm18-3.822-6 3.822 6 3.822 6-3.822zM6 18.371l6 3.822 6-3.822-6-3.822z" />
    </svg>
  )
}
