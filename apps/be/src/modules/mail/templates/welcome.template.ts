...
export const renderWelcomeEmail = (params: {
  ...
  subject: 'Welcome to SignageWall',
  html: renderEmailLayout({
    previewText: 'Your SignageWall account is ready',
    title: 'Welcome to SignageWall',
    bodyHtml: `
    ...
    footerNote: 'Welcome aboard. We are glad to have you with SignageWall.',
  }),
});
